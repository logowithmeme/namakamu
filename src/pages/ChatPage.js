//  ChatPage.js - Private Room Chat with  Identity 
...
const ChatPage = () => { 
  ...
  return ( 
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-orange-100 py
10 px-4"> 
      <div className="max-w-2xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden"> 
        ...
        <div className="px-4 py-6 h-[60vh] overflow-y-auto space-y-4"> 
          {messages.map((msg, index) => ( 
            ...
            > 
              <div 
                className={`px-4 py-2 rounded-2xl max-w-[70%] text-white text-base shadow-md 
